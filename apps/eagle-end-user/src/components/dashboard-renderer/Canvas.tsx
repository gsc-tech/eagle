...
export default function DashboardCanvas({ onLayoutChange, initialLayout }: DashboardCanvasProps) {
    ...
    const [groupedParametersValues, setGroupedParametersValues] = useState<Record<string, string>>({});

    console.log("re-rendering the canvas");
    ...
    // Handle layout changes from react-grid-layout (resize and drag within grid)
