...
import { DroppableCanvas as DashboardCanvas, type LayoutItem } from "@gsc-tech/dashboard-builder";
...
export default function DashboardWorkspaceTest() {
    ...
    useEffect(() => {
        const fetchDashboards = async () => {
            try {
                const resp = await axios.get("http://192.168.0.74:9002/dashboards/end-user");
