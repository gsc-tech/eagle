...
export const WorldMapWidget = ({ apiUrl = "http://localhost:8080/api/data", title, parameters, countryIdField = "id", valueField = "value", nameField, projection = "geoMercator", geoDataType = "world", heatmapColors = {
    min: "#d3a29f",
    max: "#6f0600"
}, defaultCountryColor = "#d9cec8", hoverColor = "#f3d191", heatLegend = true, heatLegendPosition = "bottom", valueFormat = "#,###", zoomable = true, pannable = true, rotatable = false, homeButtonEnabled = true, tooltipEnabled = true, tooltipTemplate = "{name}: {value}", darkMode = false, showCountryBorders = true, borderColor = "#ffffff", borderWidth = 1, initialZoomLevel = 1, centerCoordinates, onGroupedParametersChange, groupedParametersValues, excludeAntarctica = true, }) => {
    const chartId = useId();
