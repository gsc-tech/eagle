...
import { LiveBarChartWidget } from "../widgets/LiveBarChartWidget";
import { mockBarChartData, mockHighVolumeBarData } from "./mocks/mockWidgetData";
import { ColorType, createChart, HistogramSeries, type IChartApi, type ISeriesApi, type HistogramData, type Time } from "lightweight-charts";
import { useEffect, useMemo, useRef } from "react";
import { WidgetContainer } from "../components/WidgetContainer";
import type { BaseWidgetProps } from "../types";

interface LiveBarChartStoryProps extends BaseWidgetProps {
    dummyData: any[];
    upColor?: string;
    downColor?: string;
...
const LiveBarChartStoryWrapper: React.FC<LiveBarChartStoryProps> = ({
    parameters = [],
    fetchMode = 'manual',
    dummyData,
    upColor = "#26a69a",
    ...
    }, [backgroundColor, textColor, showYAxis, timeFormat]);
...
const meta: Meta<typeof LiveBarChartStoryWrapper> = {
    title: "Widgets/LiveBarChartWidget",
    component: LiveBarChartStoryWrapper,
    args: {
        fetchMode: "manual",
        parameters: [],
...
type Story = StoryObj<typeof LiveBarChartStoryWrapper>;
