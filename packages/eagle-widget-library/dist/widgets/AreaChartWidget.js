...
export const AreaChartWidget = ({ apiUrl = "http://localhost:8080/api/data", title, parameters, valueField = "value", dateField = "date", lineColor = "#6366f1", fillColor = "#6366f1", fillOpacity = 0.3, strokeWidth = 2, darkMode = false, onGroupedParametersChange, groupedParametersValues, }) => {
